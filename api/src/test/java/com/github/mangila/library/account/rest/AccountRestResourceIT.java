...
class AccountRestResourceIT {
  ...
  private static final LoginRequest USER_LOGIN_REQUEST = new LoginRequest("user12345", "user12345");
  ...
  @Test
  void should_me() {
    final LoginRequest loginRequest = new LoginRequest("admin12345", "admin12345");
  ...
  void should_refresh() {
    ...
    final RefreshRequest refreshRequest =
        new RefreshRequest(USER_LOGIN_REQUEST.username(), refreshToken);
