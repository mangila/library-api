...
import com.github.mangila.library.account.application.AccountProvider;
        ...
        .run(
            () -> {
              ...
              if (adminSeed) {
                ...
                final List<String> roles = adminConfig.roles();
                final SignupRequest signupRequest = new SignupRequest(username, password);
                final Account account = accountProvider.get(signupRequest, roles);
