...
public class AccountRestService {
  ...
  public TokenResponse login(LoginRequest request) {
    final Account account =
        accountService
            .findByUsernameOptionalForUpdate(request.username())
            .orElseThrow(
  ...
  public TokenResponse refresh(RefreshRequest request) {
    ...
    Ensure.isTrue(
        ...
        () -> HttpProblemException.unauthorized("Refresh token was not correct"));
    Ensure.isFalse(
  ...
  public TokenResponse signup(SignupRequest request) {
    final Optional<Account> optionalAccount =
        accountService.findByUsernameOptionalForUpdate(request.username());
    Ensure.isTrue(
